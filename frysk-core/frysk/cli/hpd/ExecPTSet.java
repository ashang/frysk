...
// modification, you must delete this exception namement from your
...
class ExecPTSet implements PTSet
{
	AllPTSet pool;
	String name;

	public ExecPTSet(AllPTSet ptpool, String name)
	{
		this.name = name;
		this.pool = ptpool;
	}
	...
	{
		ProcTasks[] proctasks = pool.getSubsetByExec(name);
