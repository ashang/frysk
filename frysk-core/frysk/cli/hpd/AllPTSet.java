...
public class AllPTSet
{
	 ...
	 */
	public StaticPTSet getSubset(ParseTreeNode[] parseTree)
	{
		TreeMap proctasks = new TreeMap();
		StaticPTSet result = null;
		...
		result = new StaticPTSet( (ProcTasks[]) (new Vector(proctasks.values()).toArray(new ProcTasks[0])) );
