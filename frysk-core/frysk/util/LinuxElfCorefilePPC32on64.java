...
/**
 * LinuxElfCorefilePPC32on64. Extends LinuxCorefile. Fill in
 * specific PPC32 on PPC64 information for corefiles.
 * 
 */
public class LinuxElfCorefilePPC32on64 extends LinuxElfCorefile {
     ...
     */
    public LinuxElfCorefilePPC32on64(Proc process, Task blockedTasks[]) {
	...
	// gap between frysk and core file register order.
        ...
        String ppc32On64RegMap[] = { "nip", "msr", "orig_r3", "ctr", "lnk",
        	"xer", "ccr", null, "trap", "dar", "dsisr", "result" };
	...
	for (int index = 0; index < ppc32On64RegMap.length; index++) {
		...
		registerVal = register
			.getRegisterByName(ppc32On64RegMap[index])
			.getBigInteger(task);
	...
	// asm-<ISA>/ptrace.h.
	blankRegisterIndex = gprSize + ppc32On64RegMap.length;	
