...
public abstract class NoOptsCommand extends Command {
    
    private final String syntax;
    private final String full;
    
    public NoOptsCommand(String description, String syntax, String full) {
	...
	if (input.parameter(0).equals("-help")) {
	    help (cli, input);
	    return;
	}
	interpretCommand(cli, input);
    }
