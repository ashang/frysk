    ...
    extends TestLib
{
  ...
  /**
   * When either Terminating, and Terminated is not INVALID, install and verify
  ...
  /**
   * Check that a process with a task, that has exited, but not yet been joined
   * (i.e., in the 'X' state) can be attached and than followed through to its
   * termination.
   */
  public void testAttachToUnJoinedTask ()
  {
    ...
    assertEquals("Number of terminating processes", 1, terminatingCounter.count);
  }
}
