...
public class X86BankRegisters {
	...
	.add(new BankRegister(1, 0x120, 16, X8664Registers.XMM8))
	.add(new BankRegister(1, 0x130, 16, X8664Registers.XMM9))
	.add(new BankRegister(1, 0x140, 16, X8664Registers.XMM10))
	.add(new BankRegister(1, 0x150, 16, X8664Registers.XMM11))
	.add(new BankRegister(1, 0x160, 16, X8664Registers.XMM12))
	.add(new BankRegister(1, 0x170, 16, X8664Registers.XMM13))
	.add(new BankRegister(1, 0x180, 16, X8664Registers.XMM14))
	.add(new BankRegister(1, 0x190, 16, X8664Registers.XMM15))
    // debug registers
