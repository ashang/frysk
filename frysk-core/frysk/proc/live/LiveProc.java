...
abstract class LiveProc extends Proc {
	...
	Manager.eventLoop.add(new ProcEvent() {
		public void execute() {
		    newState = oldState().handleRefresh(LiveProc.this);
		}
	    });
    }
	...
	Manager.eventLoop.add(new ProcEvent() {
		public void execute() {
		    newState = oldState().handleRemoval(LiveProc.this);
		}
	    });
    }
	...
	Manager.eventLoop.add(new ProcEvent() {
		...
		public void execute() {
		    newState = oldState().handleTaskAttachCompleted(LiveProc.this, task);
		}
	    });
    }
	...
	Manager.eventLoop.add(new ProcEvent() {
		Task task = theTask;
		public void execute() {
		    newState = oldState().handleTaskDetachCompleted(LiveProc.this, task);
		}
	    });
    }
	...
	Manager.eventLoop.add(new ProcEvent() {
		...
		public void execute() {
		    newState = oldState().handleTaskDetachCompleted(LiveProc.this, task, clone);
		}
	    });
    }
	...
	Manager.eventLoop.add(new ProcEvent() {
		public void execute() {
		    newState = oldState().handleDetach(LiveProc.this, true);
		}
	    });
    }
	...
	Manager.eventLoop.add(new TaskObservation(task, observable,
						  observer, false) {
		public void execute() {
		    newState = oldState().handleDeleteObservation(LiveProc.this, this);
		}
	    });
    }
	...
	TaskObservation to = new TaskObservation(task, observable, observer, sa,
						 false) {
		public void execute() {
		    newState = oldState().handleDeleteObservation(LiveProc.this,
								  this);
		}
	...
	public void run() {
		...
		if (mustInstall) {
		    ...
		    breakpoint = Breakpoint.create(address, LiveProc.this);
