...
/**
 * The DisplayManager is in charge of keeping track of the
 * UpdatingDisplayValues currently in existence
 *
 */
public class DisplayManager {
    
    /*
     * We use a map to keep track of a list of dislays for each
     * task
     */
     ...
     * 
     * @param myTask The task the displayed expression is from
     * @param fIdent The frame the displayed expression is from
     * @param engine The stepping engine controlling the task
     * @param text The expression text to create a display for
     * @return
     */
...
class DisplayMap
{
     ...
     * task, frame identifier, and expression string. Returns null if
     * no such display exists.
     */
    public UpdatingDisplayValue get(Task myTask, FrameIdentifier fIdent, String text)
    {
    ...
    /*
     * Tries to add the given DisplayValue to the DisplayMap. All
     * nested data structures are created automatically if they do not
     * already exist, and if a record of v already exists this is a no-op.
     */
    public void add(UpdatingDisplayValue v)
    {
	Map frameMap, exprMap;
	/* 
	 * Create the frame-level map for the display's task if it
	...
	/*
	 * Create the expression-level map for the given frame if
	...
	/*
	 * Add the DisplayValue to the expression-level map if it does not already
	 * exist there
	 */
    ...
    /*
     * Removes the provided display from the data structure, if it 
     * exists.
     */
