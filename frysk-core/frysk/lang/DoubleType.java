...
// exception.
  ...
  public class DoubleType extends Type
  {
    ...
    public static Variable newDoubleVariable(DoubleType type, String text, double val)  {
    ...
    public Variable newFloatVariable(FloatType type, Variable val) {
      ...
      returnVar.getLocation().putDouble(val.getFloat());
      return returnVar;
    }
	...
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (var1.getLocation().getDouble() 
	      + newVariable(var1.getType(), var2).getLocation().getDouble()));
      else
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (var1.getLocation().getDouble() 
	...
	throw (new InvalidOperatorException());
	  ...
	  ? (newVariable(var1.getType(), var2).getDouble()) 
	  : var2.getDouble());
      return var1;
    }
	...
	throw (new InvalidOperatorException());
      ...
      var1.putDouble((var2.getType().getTypeId() != BaseTypes.baseTypeDouble) 
	  ? (var1.getDouble() * newVariable(var1.getType(), var2).getDouble()) 
	  : var1.getDouble() * var2.getDouble());
      return var1;
    }
	...
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (var1.getLocation().getDouble() * var2.getLocation().getDouble()));
    }
	...
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (var1.getLocation().getDouble() 
	      < newVariable(var1.getType(), var2).getLocation().getDouble()) ? 1 : 0);
      else
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (var1.getLocation().getDouble() < var2.getLocation().getDouble()) ? 1 : 0);
    }
	...
	return DoubleType.newDoubleVariable
	    ((DoubleType)(var1.getType()), 
	     (int)((var1.getLocation().getDouble() == var2.getLocation().getDouble()) ? 1 : 0));
    }
	...
	Class objCons[] = {Class.forName("DoubleType")};
    ...
    Type addTo(Type type) {
      return (Type)(new DoubleType(_size, (int)(_location.getDouble() + type.getLocation().getDouble())));
    }*/
  }
