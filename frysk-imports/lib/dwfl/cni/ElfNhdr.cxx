...
jint
lib::dwfl::ElfNhdr::getNhdrSize()
{
	return sizeof(GElf_Nhdr);
}

jlong 
lib::dwfl::ElfNhdr::fillNhdr(jbyteArray buffer, jlong startAddress)
{
...
jlong 
lib::dwfl::ElfNhdr::fillNhdrName(jbyteArray buffer, jlong startAddress)
{
	jlong size = 0; 
	jbyte *bs = elements(buffer) + startAddress;
