...
{   
  ...
  public Object getProcName (final long addr, final int maxNameSize)
  {
    ...
    class ExecuteGetProcName
    {
      ...
      //This can not be an Object, must be a custom class.
      MyProcName procName;    
      ...
      public void execute ()
      {
        ...
        if (maxNameSize != 100)
          throw new RuntimeException("Bad maxNameSize should be 100, was: " + maxNameSize);
       }
    }
  ...
  {
    StackAccessors accessors = new StackAccessors();
    accessors.getProcName(0, 100);
