...
public class PrintDebugMacinfo
    implements Print
{
    DebugMacinfo debugMacinfoSection;
    public PrintDebugMacinfo (DebugMacinfo debugMacinfoSection)
    {
	this.debugMacinfoSection = debugMacinfoSection;
    }
    public PrintDebugMacinfo (Dwarf dwarf)
    {
	this (dwarf.getDebugMacinfo ());
    }

    class PrintMacinfoBuilder
	extends DebugMacinfo.Builder
    {
	PrintWriter o;
	PrintMacinfoBuilder (PrintWriter f)
	{
	    o = f;
	}
    }
