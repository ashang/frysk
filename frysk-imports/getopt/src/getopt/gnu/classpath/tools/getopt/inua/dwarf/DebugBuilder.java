...
class DebugBuilder
{
	...
	public static final Action PARSE = new Action ("PARSE");
	public static final Action BREAK = new Action ("BREAK");
	public static final Action SKIP = new Action ("SKIP");
	// static final Action CONTINUE = new Action ("CONTINUE"); // aka skip
	// static final Action SUSPEND = new Action ("SUSPEND");
    }
}
