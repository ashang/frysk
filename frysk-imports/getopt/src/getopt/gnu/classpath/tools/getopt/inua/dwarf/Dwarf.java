...
interface Dwarf
{
    DebugAbbrev getDebugAbbrev ();
    DebugAranges getDebugAranges ();
    DebugFrame[] getDebugFrames ();
    DebugInfo getDebugInfo ();
    DebugLine getDebugLine ();
    DebugLoc getDebugLoc ();
    DebugMacinfo getDebugMacinfo ();
    DebugPubs getDebugPubnames ();
    DebugPubs getDebugPubtypes ();
    DebugRanges getDebugRanges ();
    DebugStr getDebugStr ();
}
