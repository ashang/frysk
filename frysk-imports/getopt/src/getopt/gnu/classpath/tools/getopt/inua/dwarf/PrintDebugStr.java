...
public class PrintDebugStr
    implements Print
{
    DebugStr debugStrSection;
    public PrintDebugStr (DebugStr debugStrSection)
    {
	this.debugStrSection = debugStrSection;
    }
    public PrintDebugStr (Dwarf dwarf)
    {
	this (dwarf.getDebugStr ());
    }

    public void print (PrintWriter o)
    {
	o.print ("Contents of the .debug_str section:");
	o.println ();
	o.println ();
	long offset = 0;
	...
	do {
		...
		if ((i % 4) == 0)
		    o.print (' ');
		if (debugStrSection.hasRemaining ()) {
		    byte c = debugStrSection.getByte ();
		    o.printx (2, '0', c);
	    ...
	    o.print (' ');
	    o.print (line.toString());
	    o.println ();
	    offset += 4 * 4;
	    line.setLength (0);
	} while (debugStrSection.hasRemaining ());
    }
