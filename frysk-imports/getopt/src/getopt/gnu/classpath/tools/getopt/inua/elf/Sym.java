...
public class Sym {
    ...
    void read (ElfBuffer buffer)
    {
	name = buffer.getSignedWord ();
	value = buffer.getSignedWord ();
	size = buffer.getSignedWord ();
	info = buffer.getSignedByte ();
	other = buffer.getSignedByte ();
	shndx = buffer.getUnsignedHalf ();
    }
