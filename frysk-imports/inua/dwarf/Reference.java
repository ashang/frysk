...
// A reference from the .debug_info into one of the other sections
// (e.g., .debug_ranges, .debug_loc).  The reference is context
// sensitive: in addition to the offset it requires the data-format of
// the referee's compilation unit.
    ...
    implements Comparable
{
    Format format;
    long offset;
    Reference (Format format, long offset)
    {
	this.format = format;
	this.offset = offset;
    }
