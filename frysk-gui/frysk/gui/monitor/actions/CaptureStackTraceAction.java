    ...
    extends TaskAction
{
  ...
  public CaptureStackTraceAction ()
  {
    super("Capture a stack trace of ", "Capture a stack trace of the task");
  }

  public CaptureStackTraceAction (CaptureStackTraceAction other)
  {
    super(other);
  }
  ...
  public void execute (Task task , TaskObserverRoot observer, Event event)
  {
    ...
    event.setStackFrame(frame);
  }

  public GuiObject getCopy ()
  {
    return new CaptureStackTraceAction(this);
  }
