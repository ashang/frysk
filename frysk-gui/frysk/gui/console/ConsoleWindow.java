...
/*    public void run ()
  ...
  public ConsoleWindow ()
  {
    ...
    term = new Terminal();
    //term = new Terminal("/bin/bash", cmdargs, "/home/rmoseley");
    term.setPty(master);
    ...
    System.out.println("ConsoleWindow: name = " + name);

    //reader rd = new reader(name);
    //System.out.println("ConsoleWindow: before call to Thread(rd).start()");
    //new Thread(rd).start();
    //System.out.println("ConsoleWindow: after call to Thread(rd).start()");
  }
