...
public class ElfPrXFPRegSet extends ElfNhdr.ElfNoteSectionEntry
{
  ...
  private ElfPrXFPRegSet(byte[] singleNoteData, Elf elf)
  {
  ...
  public static ElfPrXFPRegSet[] decode(ElfData noteData)
  {
    ...
    ElfPrXFPRegSet threadList[] = new  ElfPrXFPRegSet[internalThreads.size()];
    ...
    while (i.hasNext())
      {
	byte b[]  = (byte[]) i.next();
	threadList[count] = new ElfPrXFPRegSet(b,noteData.getParent());
	count++;
      }
