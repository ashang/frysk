...
#include "lib/dwfl/ElfArchiveSymbol.h"
...
jstring
lib::dwfl::ElfArchiveSymbol::elf_as_get_name (){
	char* name = ((Elf_Arsym*) this->pointer)->as_name;
	return JvNewString((const jchar*) name, strlen(name));
}

jint
lib::dwfl::ElfArchiveSymbol::elf_as_get_offset (){
	return ((Elf_Arsym*) this->pointer)->as_off;
}

jlong
lib::dwfl::ElfArchiveSymbol::elf_as_get_hash (){
