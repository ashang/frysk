...
jlong
lib::dwfl::ElfSection::elf_ndxscn (){
	return ::elf_ndxscn((Elf_Scn*) this->pointer);
}

lib::dwfl::ElfSectionHeader*
lib::dwfl::ElfSection::elf_getshdr (){
	GElf_Shdr tmp;

	if(::gelf_getshdr((Elf_Scn*) this->pointer, &tmp) == NULL)
		return NULL;
		
	lib::dwfl::ElfSectionHeader *header = new lib::dwfl::ElfSectionHeader(this->parent);
...
jint
lib::dwfl::ElfSection::elf_updateshdr (lib::dwfl::ElfSectionHeader *section){
	GElf_Shdr header;
