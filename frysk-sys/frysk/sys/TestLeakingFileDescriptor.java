...
/**
 * Testing a leaked FileDescriptor.
 */

public class TestLeakingFileDescriptor
    extends TestCase
{
    /**
     * Table of all the still open file descriptors; any closed will
     * have been removed from the map.
     */
    private WeakHashMap fds;
